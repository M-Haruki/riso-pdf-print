...
::: tip
ページ数の多いPDFを印刷しようとすると、1ページ目しかUSBに保存できなかったり、リソでの読み込みに時間がかかったりする場合があります。  
...
リソにUSBを挿す前に、追加したジョブのページ数などを確認して、ただしく保存されているか確認してください。

使い終わったジョブを消したい場合、ジョブ名を選択後、`削除`をクリックします。
